      ...
      <div className="grid min-h-screen grid-cols-1 md:grid-cols-2">
        <section className="relative hidden overflow-hidden bg-[linear-gradient(160deg,#0d2818_0%,#1a3a2a_60%,#2d5a3d_100%)] px-16 py-20 md:flex md:flex-col md:justify-center lg:px-20">
          ...
          <Link to="/" className="relative z-10 mb-12 inline-flex items-center gap-2.5">
            <span className="grid size-9 place-items-center rounded-[10px] bg-[#16A34A] text-white">
          ...
          <div className="relative z-10">
            <h1 className="font-['Space_Grotesk',sans-serif] text-[2.4rem] font-bold leading-[1.1] tracking-[-0.03em] text-white">
              Set a new <span className="text-[#16A34A]">password.</span>
            </h1>
        ...
        <section className="flex min-h-screen flex-col justify-center bg-white px-6 py-10 sm:px-10 md:px-16 lg:px-20">
          <div className="mx-auto w-full max-w-[420px]">
            <div className="mb-7">
              <h2 className="font-['Space_Grotesk',sans-serif] text-[1.6rem] font-bold tracking-[-0.02em] text-[#1E293B]">Set a new password</h2>
            ...
            <form onSubmit={onSubmit} className="space-y-4.5">
              <div className="space-y-1.5">
                <Label htmlFor="password" className="text-[0.8rem] font-semibold text-[#1E293B]">New password</Label>
                <Input
                  id="password"
                  type="password"
                  ...
                  className="h-11 rounded-[10px] border-[1.5px] border-[#E2E8F0] bg-[#FFFFFF] px-3.5 text-[0.9rem] text-[#1E293B] placeholder:text-[#94A3B8] focus-visible:ring-[#16A34A]/20"
                />
              </div>

              <div className="space-y-1.5">
                <Label htmlFor="confirmPassword" className="text-[0.8rem] font-semibold text-[#1E293B]">Confirm password</Label>
                <Input
                  id="confirmPassword"
                  type="password"
                  autoComplete="new-password"
              ...
              <Button
                type="submit"
                className="h-12 w-full rounded-[10px] bg-[#16A34A] text-[0.95rem] font-semibold text-white hover:bg-[#15803D] disabled:bg-[#E2E8F0]"
                disabled={busy}
              >
            ...
            <p className="mt-6 text-center text-[0.85rem] text-[#6B7280]">
              Password updated?{" "}
              <Link to="/auth/login" className="font-semibold text-[#16A34A] hover:underline">
                Go to login
              </Link>
            </p>
          </div>
